...
export default function CreatePage() {
  ...
  const ONBOARDING_STEPS = [
    ...
    { icon: '🖼️', title: '② 換個背景模板', desc: '卡片上方有 3 種背景可以切換，找一個最喜歡的。' },
    { icon: '🎁', title: '③ 加入可愛素材', desc: '在左側素材包點選貼圖加入卡片，可拖曳移動、縮放，雙擊移除。' },
    { icon: '✍️', title: '④ 生成專屬祝福語', desc: '右側可一鍵生成祝福語，也可以自己修改文字和字型大小。' },
    { icon: '💌', title: '⑤ 預覽 & 分享給媽媽', desc: '點「預覽 & 分享卡片」確認後，手機直接分享到 LINE！' },
  ];
